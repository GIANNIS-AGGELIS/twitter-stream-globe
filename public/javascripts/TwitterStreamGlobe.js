(function () {
	...
	function addEarth () {
	  ...
	  var sphereGeometry = new THREE.SphereGeometry(400, 50, 50);

	  var shader = Shaders.earth;
	  var uniforms = THREE.UniformsUtils.clone(shader.uniforms);

	  uniforms['texture'].value = THREE.ImageUtils.loadTexture('/images/water_4k.jpg');
	...
	function render () {
		...
		earthMesh.rotation.y = earthMesh.rotation.y - 0.035;
